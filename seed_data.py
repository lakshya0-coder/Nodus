    ...
    with app.app_context():
        ...
        items_data = [
            ...
            {'cat': 'Coffee', 'name_en': 'Artisan Latte', 'name_hi': 'आर्टिज़न लैटे',
             ...
             'price': 249, 'tags': ['Bestseller'], 'image_path': 'images/menu_items/artisan_latte.png'},
            {'cat': 'Coffee', 'name_en': 'Double Shot Espresso', 'name_hi': 'डबल शॉट एस्प्रेसो',
             ...
             'price': 179, 'tags': [], 'image_path': 'images/menu_items/espresso.png'},
            {'cat': 'Coffee', 'name_en': 'Cappuccino', 'name_hi': 'कैपुचिनो',
             ...
             'price': 199, 'tags': ['Bestseller', 'Popular'], 'image_path': 'images/menu_items/cappuccino.png'},
            {'cat': 'Coffee', 'name_en': 'Caramel Latte', 'name_hi': 'कैरामेल लैटे',
             ...
             'price': 249, 'tags': ['Popular'], 'image_path': 'images/menu_items/caramel_latte.png'},
            {'cat': 'Coffee', 'name_en': 'Mocha', 'name_hi': 'मोका',
             ...
             'price': 269, 'tags': [], 'image_path': 'images/menu_items/mocha.png'},
            {'cat': 'Coffee', 'name_en': 'Lavender Latte', 'name_hi': 'लैवेंडर लैटे',
             ...
             'price': 289, 'tags': ['New', 'Vegan'], 'image_path': 'images/menu_items/lavender_latte.png'},
            {'cat': 'Coffee', 'name_en': 'Double Shot Americano', 'name_hi': 'डबल शॉट अमेरिकानो',
             ...
             'price': 179, 'tags': [], 'image_path': 'images/menu_items/americano.png'},
            {'cat': 'Coffee', 'name_en': 'Hazelnut Mocha', 'name_hi': 'हेज़लनट मोका',
             ...
             'price': 279, 'tags': ['New'], 'image_path': 'images/menu_items/hazelnut_mocha.png'},
            ...
            {'cat': 'Tea', 'name_en': 'Masala Chai', 'name_hi': 'मसाला चाय',
             ...
             'price': 99, 'tags': ['Bestseller'], 'image_path': 'images/menu_items/masala_chai.png'},
            {'cat': 'Tea', 'name_en': 'Green Tea', 'name_hi': 'ग्रीन टी',
             ...
             'price': 129, 'tags': ['Vegan'], 'image_path': 'images/menu_items/green_tea.png'},
            {'cat': 'Tea', 'name_en': 'Earl Grey', 'name_hi': 'अर्ल ग्रे',
             ...
             'price': 149, 'tags': [], 'image_path': 'images/menu_items/earl_grey.png'},
            {'cat': 'Tea', 'name_en': 'Chamomile Dream', 'name_hi': 'कैमोमाइल ड्रीम',
             ...
             'price': 159, 'tags': ['Vegan'], 'image_path': 'images/menu_items/chamomile.png'},
            ...
            {'cat': 'Cold Beverages', 'name_en': 'Iced Caramel Macchiato', 'name_hi': 'आइस्ड कारमेल मैकियाटो',
             ...
             'price': 289, 'tags': ['Popular'], 'image_path': 'images/menu_items/iced_macchiato.png'},
            {'cat': 'Cold Beverages', 'name_en': 'Cold Brew', 'name_hi': 'कोल्ड ब्रू',
             ...
             'price': 229, 'tags': ['Bestseller'], 'image_path': 'images/menu_items/cold_brew.png'},
            {'cat': 'Cold Beverages', 'name_en': 'Iced Matcha Latte', 'name_hi': 'आइस्ड माचा लैटे',
             ...
             'price': 259, 'tags': ['Vegan', 'New'], 'image_path': 'images/menu_items/iced_matcha.png'},
            {'cat': 'Cold Beverages', 'name_en': 'Rose Lemonade', 'name_hi': 'रोज़ लेमोनेड',
             ...
             'price': 169, 'tags': ['Vegan'], 'image_path': 'images/menu_items/rose_lemonade.png'},
            ...
            {'cat': 'Smoothies & Shakes', 'name_en': 'Mango Tango Smoothie', 'name_hi': 'मैंगो टैंगो स्मूदी',
             ...
             'price': 219, 'tags': ['Popular'], 'image_path': 'images/menu_items/mango_smoothie.png'},
            {'cat': 'Smoothies & Shakes', 'name_en': 'Berry Bliss', 'name_hi': 'बेरी ब्लिस',
             ...
             'price': 239, 'tags': ['Vegan'], 'image_path': 'images/menu_items/berry_bliss.jpg'},
            {'cat': 'Smoothies & Shakes', 'name_en': 'Chocolate Peanut Butter Shake', 'name_hi': 'चॉकलेट पीनट बटर शेक',
             ...
             'price': 269, 'tags': ['Popular'], 'image_path': 'images/menu_items/choco_peanut_shake.jpg'},
            ...
            {'cat': 'Snacks', 'name_en': 'Avocado Toast', 'name_hi': 'एवोकाडो टोस्ट',
             ...
             'price': 299, 'tags': ['Vegan', 'Popular'], 'image_path': 'images/menu_items/avocado_toast.jpg'},
            {'cat': 'Snacks', 'name_en': 'Paneer Tikka Wrap', 'name_hi': 'पनीर टिक्का रैप',
             ...
             'price': 249, 'tags': ['Spicy', 'Bestseller'], 'image_path': 'images/menu_items/paneer_wrap.jpg'},
            {'cat': 'Snacks', 'name_en': 'Croissant (Butter)', 'name_hi': 'क्रोसॉन्ट (बटर)',
             ...
             'price': 149, 'tags': [], 'image_path': 'images/menu_items/croissant.jpg'},
            {'cat': 'Snacks', 'name_en': 'Loaded Nachos', 'name_hi': 'लोडेड नाचोज़',
             ...
             'price': 279, 'tags': ['Spicy'], 'image_path': 'images/menu_items/nachos.jpg'},
            ...
            {'cat': 'Desserts', 'name_en': 'Tiramisu', 'name_hi': 'तिरामिसू',
             ...
             'price': 349, 'tags': ['Bestseller'], 'image_path': 'images/menu_items/tiramisu.jpg'},
            {'cat': 'Desserts', 'name_en': 'New York Cheesecake', 'name_hi': 'न्यूयॉर्क चीज़केक',
             ...
             'price': 329, 'tags': ['Popular'], 'image_path': 'images/menu_items/cheesecake.jpg'},
            {'cat': 'Desserts', 'name_en': 'Chocolate Lava Cake', 'name_hi': 'चॉकलेट लावा केक',
             ...
             'price': 299, 'tags': ['New'], 'image_path': 'images/menu_items/lava_cake.jpg'},
            {'cat': 'Desserts', 'name_en': 'Gulab Jamun', 'name_hi': 'गुलाब जामुन',
             ...
             'price': 199, 'tags': ['Popular'], 'image_path': 'images/menu_items/gulab_jamun.jpg'},
        ]
        ...
        for item_data in items_data:
            ...
            if not existing:
                ...
                existing.image_path = item_data.get('image_path', '')
